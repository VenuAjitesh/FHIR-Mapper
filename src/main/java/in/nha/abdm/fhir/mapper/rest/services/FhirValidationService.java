...
import in.nha.abdm.fhir.mapper.rest.dto.validation.ValidationResult.ValidationIssue;
...
public class FhirValidationService {
  ...
  public in.nha.abdm.fhir.mapper.rest.dto.validation.ValidationResult validateBundle(
      Bundle bundle) {
  ...
  private in.nha.abdm.fhir.mapper.rest.dto.validation.ValidationResult createValidResult() {
    return in.nha.abdm.fhir.mapper.rest.dto.validation.ValidationResult.builder()
        .valid(true)
        .issues(List.of())
        .errorCount(0)
        .warningCount(0)
  ...
  private in.nha.abdm.fhir.mapper.rest.dto.validation.ValidationResult createValidationResult(
  ...
  private in.nha.abdm.fhir.mapper.rest.dto.validation.ValidationResult createErrorResult(
      String message) {
