...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = DatabaseTableConstants.LOINC_CODE)
public class LoincCode implements Displayable {
  @Id public String code;

  public String display;

  @Builder.Default public String type = SnomedCodeIdentifier.LOINC;
}
