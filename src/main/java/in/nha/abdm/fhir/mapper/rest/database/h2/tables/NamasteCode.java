...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = DatabaseTableConstants.NAMASTE_CODE)
public class NamasteCode implements Displayable {
  @Id public String code;

  public String display;

  @Builder.Default public String type = SnomedCodeIdentifier.NAMASTE;
}
