...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = DatabaseTableConstants.SNOMED_ENCOUNTER)
public class SnomedEncounter implements Displayable {
  @Id public String code;

  public String display;

  @Builder.Default public String type = SnomedCodeIdentifier.SNOMED_ENCOUNTER;
}
