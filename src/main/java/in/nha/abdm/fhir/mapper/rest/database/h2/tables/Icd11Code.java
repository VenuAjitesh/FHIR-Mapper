...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = DatabaseTableConstants.ICD11_CODE)
public class Icd11Code implements Displayable {
  @Id public String code;

  public String display;

  @Builder.Default public String type = SnomedCodeIdentifier.ICD11;
}
