...
public class InvoiceBundleRequest {
    ...
    @NotNull(message = "authoredOn is mandatory timestamp")
    ...
    @Valid
    @NotNull(message = "chargeItems are mandatory and must not be empty")
    private List<ChargeItemResource> chargeItems;
    @Valid
    @NotNull(message = "payment is mandatory and must not be empty")
    private InvoicePaymentResource payment;
}
