...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = DatabaseTableConstants.SNOMED_DIAGNOSTIC)
@Builder
public class SnomedDiagnostic implements Displayable {
  @Id public String code;

  public String display;

  @Builder.Default public String type = SnomedCodeIdentifier.SNOMED_DIAGNOSTICS;
}
