...
public class MakeInvoiceSubstanceResource {
    public Substance getSubstance(InvoiceSubstanceResource substanceResource) {
        ...
        substance.setCategory(Collections.singletonList(new CodeableConcept().setText(substanceResource.getCategory())));
        substance.setInstance(Collections.singletonList(new Substance.SubstanceInstanceComponent()
                .setQuantity(substanceResource.getQuantity() != 0.0 ? new Quantity().setValue(substanceResource.getQuantity()) : null)
